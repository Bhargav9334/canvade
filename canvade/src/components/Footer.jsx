  ...
  <span className="text-[#cccccc] text-[11px] md:text-[12px] group-hover:text-white transition-colors">
    {link}
          ...
          <div className="lg:col-span-3">
            <div className="space-y-4">
              ...
              <textarea
                ...
                rows="3"
                className="w-full bg-white rounded-lg px-4 py-3 text-gray-800 text-sm  outline-none placeholder:text-gray-400 resize-none border border-transparent focus:border-emerald-500 transition-all"
              ></textarea>
              <div className="flex justify-end">
                <button className="w-full sm:w-auto bg-[#e0e0e0] text-[#333333] px-8 py-2.5 rounded-lg text-sm font-heading font-bold hover:bg-emerald-600 hover:text-white transition-all duration-300 active:scale-95 shadow-sm">
                  Send Message
                </button>
              </div>
            </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-6 ">
          ...
          <div className="text-[12px] md:text-[13px] font-heading font-bold text-center lg:text-left text-white/90 tracking-tight order-1 lg:order-2 cursor-pointer">
